// Luck.fyi crypto drum — top cryptocurrencies
// Same drum shape + physics as the lottery mixers; each ball is a coin's brand colour + initial.
function startLotteryDrum(canvasId) {
    ...
    // ===== coins — brand colour + initial; text auto-contrasts (white, or dark on pale balls) =====
    function txtColor(hex){ const r=parseInt(hex.slice(1,3),16),g=parseInt(hex.slice(3,5),16),b=parseInt(hex.slice(5,7),16); return (0.299*r+0.587*g+0.114*b)>170?'#15140f':'#ffffff'; }
    const COINS = [
      {c:'#F7931A',l:'B'},{c:'#627EEA',l:'E'},{c:'#26A17B',l:'T'},{c:'#F3BA2F',l:'B'},{c:'#9945FF',l:'S'},
      {c:'#3F8CD6',l:'X'},{c:'#2775CA',l:'U'},{c:'#0A60FF',l:'C'},{c:'#C2A633',l:'D'},{c:'#EF0027',l:'T'},
      {c:'#E84142',l:'A'},{c:'#2A5ADA',l:'C'},{c:'#E6007A',l:'P'},{c:'#8247E5',l:'P'},{c:'#4D6FAF',l:'L'},
      {c:'#FFA409',l:'S'},{c:'#0AC18E',l:'B'},{c:'#3AB8E8',l:'S'},{c:'#FF007A',l:'U'},{c:'#6F7CBA',l:'C'},
      {c:'#FF6600',l:'M'},{c:'#11CABE',l:'A'},{c:'#00C58E',l:'N'},{c:'#15BDFF',l:'V'},{c:'#0090FF',l:'F'},
      {c:'#29ABE2',l:'I'},{c:'#1AAB9B',l:'M'},{c:'#28A0F0',l:'A'},{c:'#FF0420',l:'O'},{c:'#B6509E',l:'A'},
      {c:'#1199FA',l:'C'},{c:'#6747ED',l:'G'},{c:'#1969FF',l:'F'},{c:'#2C7DF7',l:'T'},{c:'#2AB8E6',l:'T'},
      {c:'#00ADEF',l:'S'},{c:'#FF2D55',l:'D'},{c:'#00C46F',l:'F'},{c:'#CD0124',l:'C'},{c:'#1FC7D4',l:'P'},
      {c:'#FF6F4C',l:'R'},{c:'#00A2FF',l:'I'},{c:'#F56C6C',l:'L'},{c:'#49EACB',l:'K'},{c:'#4DA2FF',l:'S'},
      {c:'#0098EA',l:'T'},{c:'#3FA130',l:'P'},{c:'#FFAE00',l:'B'},{c:'#3CC8C8',l:'M'},{c:'#5546FF',l:'S'}
    ];
    ...
    for (const coin of COINS) {
        const p = spawn();
        balls.push(new Ball(p.x, p.y, random(-2.4, 2.4), random(-1.4, 3.4), size, coin.l, coin.c, txtColor(coin.c)));
    }
